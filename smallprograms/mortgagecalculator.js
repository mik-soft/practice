...
{
    let result = readline.question(`${message} \n`)
    return Number(result)
}

let p = prompt("What is the loan amount?: ")
let j = prompt("What is the monthly interest rate?: ")
let n = prompt("What is the loan duration (in months)?: ")
j = (j/100)/n

let m = p * (j / (1 - Math.pow((1 + j), (-n))));
console.log(`Your monthly payment will be: ${Number.parseFloat(m).toFixed(2)}`)
